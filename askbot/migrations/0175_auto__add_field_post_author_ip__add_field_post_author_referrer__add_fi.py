...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Post.author_ip'
        db.add_column('askbot_post', 'author_ip',
                      self.gf('django.db.models.fields.GenericIPAddressField')(max_length=39, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Post.author_referrer'
        db.add_column('askbot_post', 'author_referrer',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Post.author_user_agent'
        db.add_column('askbot_post', 'author_user_agent',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Post.author_ip'
        db.delete_column('askbot_post', 'author_ip')

        # Deleting field 'Post.author_referrer'
        db.delete_column('askbot_post', 'author_referrer')

        # Deleting field 'Post.author_user_agent'
        db.delete_column('askbot_post', 'author_user_agent')
    ...
    models = {
        ...
        'askbot.attachment': {
            ...
            'filehash': ('django.db.models.fields.CharField', [], {'default': "'cd2c205c5b495f070ae3aabbda50d9ad'", 'unique': 'True', 'max_length': '200'}),
        ...
        'askbot.post': {
            ...
            'author_referrer': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'author_user_agent': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
        ...
        u'auth.user': {
            ...
            'linkedin_profile': ('django.db.models.fields.URLField', [], {'max_length': '100', 'blank': 'True'}),
