...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'askbot_attachment', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('filehash', self.gf('django.db.models.fields.CharField')(unique=True, max_length=200)),
            ('filename', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal('askbot', ['Attachment'])


    def backwards(self, orm):
        # Deleting model 'Attachment'
        db.delete_table(u'askbot_attachment')
    ...
    models = {
        ...
        'askbot.attachment': {
            ...
            'filehash': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '200'}),
